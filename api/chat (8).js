...
Keahlian: Ternak, Unggas, Aquaculture, Pertanian, Hortikultura, Perkebunan, Insekta, Herbal.`;
    ...
    const MODELS = [
      'openrouter/free',                              // auto-router official OpenRouter
      'google/gemma-3-27b-it:free',                  // confirmed active March 2026
      'google/gemma-3-12b-it:free',                  // confirmed active March 2026
      'meta-llama/llama-3.3-70b-instruct:free',      // exists, may 429
      'nousresearch/hermes-3-llama-3.1-405b:free',   // exists, may 429
    ];
